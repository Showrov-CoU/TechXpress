const Footer = () => {
  return (
    <div>
      <footer className="footer flex justify-around p-10 bg-color-primary-dark text-color-white">
        <nav className="">
          <header className="footer-title text-color-white">Brand</header>
        ...
        <nav>
          <header className="footer-title">TechXpress</header>
          ...
          <div className="grid grid-flow-col gap-4">
            <a>
              <svg
                ...
                height="24"
                viewBox="0 0 24 24"
                className="fill-current text-color-secondary"
              >
